function cfg = topoplot_common_JF(cfg, varargin)

% This version has been edited by Joel to do the plotting so that we don't
% need to clean up in Illustrator 
...
% Set ft_plot_topo_JF specific options
...
if ~strcmp(cfg.style,'blank')
  ...
  %ft_plot_topo_JF(chanX,chanY,dat,opt{:});
